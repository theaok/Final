...
/* A final project for Data Management in Stata. I have organized data from seven 
different datasets and created a new master dataset that includes various county
level measurements from New Jersey.   
...
/*>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
								...
								PREPARING DATASETS  
		    Download, Loop, Drop, rename, Keep, Destring, Generate, Replace
...
//Programming
//For an ado for data that does not require firstrow clarification 
cap program drop Google
program define Google
global gooPre 
global gooSuf 
...
//Programming an ado for Downloading Data with First Row Clear 
cap program drop GoogleFR
program define GoogleFR 
global gooPre 
global gooSuf 
local goohealth= "https://docs.google.com/uc?id=" + "`1'" + "&export=download"
...
Google "0B1opnkI-LLCiZFZKbzhlOFN4Sm8"
...
cap program drop kregion
program define kregion
...
//Loop 
Google "0B1opnkI-LLCiWk1BYUc3R3FFWkE"
...
//Loop 
Google "0B1opnkI-LLCiZHRMT3BWNEZjNW8"
...
//Loop 
Google "0B1opnkI-LLCianducmRLbl84dzQ"
...
GoogleFR "0B1opnkI-LLCic1lHUUxUZHhvZGs"
...
//Loop
GoogleFR "0B1opnkI-LLCicWZRS3c2MFhianM"
...
//Loop 
GoogleFR "0B1opnkI-LLCiV2tGMjhfTTZjWkE"
...
address issues of food access, poverty and health and to further analyze the usefulness of 
...
food stamps, cooking classes and healthy eating programming, but the question 
remains- are they working and what else can be done to counter these negative 
health outcomes?

In the future I will continue to look into how this data intersects with race 
and pollution. In the future I will also try to incorporate SNAP data in 
